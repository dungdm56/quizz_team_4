...
def create_quizz(request, id_class):
    ...
    return render_to_response('creation/quizzes_creation.html', context_instance=RequestContext(request, {'form': form, 'User': request.user, 'classes_list': classes_list}))
...
def create_question(request, id_quizz):
    ...
    return render_to_response('creation/questions_creation.html', {'state': state}, context_instance=RequestContext(request, {'User': request.user, 'Quizzes': quizz}))
